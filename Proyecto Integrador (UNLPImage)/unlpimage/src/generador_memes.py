    ...
    if file_extension != 'Cancelar':
        ...
        if confirmation == 'Yes':            
            ...
            try:            
                ...
                logs.log_system(current_user, 'Generacion de meme', img_name, texts)
...
def create_window(img_data, img_path):
    ...
    ----------
        img_data: dict
            Diccionario que contiene los datos del template seleccionado.
        img_path: str
            String que contiene la ruta de la imagen seleccionada para usar de template de meme.
...
def generador_memes(user_Data, my_template):
    ...
    my_template: str
        String con el nombre del template que se desea usar para crear el meme.
